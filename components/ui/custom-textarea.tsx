...
import React, { KeyboardEvent, TextareaHTMLAttributes, useEffect, useRef } from 'react'
...
const CustomTextareaForm: React.FC<CustomTextareaFormProps & TextareaHTMLAttributes<HTMLTextAreaElement>> = ({
    value,
    setValue,
    onSubmit,
    isVisible,
