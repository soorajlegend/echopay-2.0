...
> = ({ value, onChange, onSubmit, className, disabled, ...rest }) => {
  ...
  return (
    ...
    >
      <div className="w-full lg:max-w-4xl mx-auto flex items-end dark:ring-arsenic rounded-lg gap-2 focus-visible:ring-0 ring-1 ring-gray-200/60 bg-gray-200/50 focus-visible:border-none p-2 mb-5 lg:mb-0">
        <textarea
          value={value}
          disabled={disabled}
          ref={textareaRef}
