        ...
        >
            <motion.div
                ...
                className={cn(
                    ...
                    !isAssistant && `bg-gray-300/40 text-gray-600 dark:text-white max-w-[80%] ml-auto rounded-3xl p-2`,
                )}>
                <div className={cn(
                    ...
                    {data.role === "model" &&
                        <Avatar className={cn(
                            'w-9 h-9 aspect-square dark:bg-gray-900/40 ',
                        )}>
                    ...
                    >
                        <div className={cn(
                            ...
                            <ReactMarkdown className="styled-scrollbar"
