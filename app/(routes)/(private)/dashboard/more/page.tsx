...
import { MoveLeft, User, HelpCircle, Share2, ChevronRight } from 'lucide-react'
          ...
          <CardContent>
            <ul className="space-y-4">
              {section.links.map((link, linkIndex) => (
                <li key={linkIndex}>
                  <Link href={link.url} className="flex justify-between items-center text-[16px] text-[#434343] my-[16px] py-2">
                    {link.title}
